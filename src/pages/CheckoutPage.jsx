      ...
      <div className="p-4 space-y-4">
        {step === 0 && (
          <>
            ...
            <button style={{ width: '100%', marginTop: 10, padding: '10px 0', borderRadius: 'var(--radius)', border: '1.5px dashed var(--border-strong)', background: 'none', color: 'var(--text-muted)', fontSize: 13, cursor: 'pointer', fontWeight: 500, transition: 'all .2s' }}>
              + Yangi manzil
            </button>
          </div>
          </>
          ...
          <>
            ...
            <div className="card p-4 animate-fade-in-up" style={{ animationDelay: '.1s' }}>
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between" style={{ fontSize: 13 }}><span style={{ color: 'var(--text-muted)' }}>Yetkazish</span><span style={{ color: 'var(--success)', fontWeight: 500 }}>Bepul</span></div>
                <div className="flex justify-between" style={{ fontSize: 13 }}><span style={{ color: 'var(--text-muted)' }}>Xizmat haqi</span><span style={{ color: 'var(--text)' }}>+{totals.serviceFee.toLocaleString()} so'm</span></div>
