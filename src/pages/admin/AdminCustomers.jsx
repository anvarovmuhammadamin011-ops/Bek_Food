...
const MOCK_CUSTOMERS = [
  {
    ...
    favoriteDish: 'Hot-dog oddiy',
    avgCheck: 7180,
    rating: 4.9,
    blacklisted: false,
    notes: "VIP mijoz. Har doim 123-stolni so'raydi.",
    orders: [
      { id: 1001, date: '2026-07-27T18:30:00', total: 125000, items: ['Hot-dog oddiy', 'Hot-dog 2x (Double)', 'Doner kichik'] },
      { id: 1002, date: '2026-07-25T19:15:00', total: 89000, items: ['Hot-dog oddiy', 'Fri'] },
      { id: 1003, date: '2026-07-22T20:00:00', total: 145000, items: ['Hot-dog oddiy', 'Mushroom Soup', 'Sparkling Water'] },
      { id: 1004, date: '2026-07-20T17:45:00', total: 67000, items: ['Hot-dog 2x (Double)', 'Coleslaw'] },
      { id: 1005, date: '2026-07-18T19:30:00', total: 112000, items: ['Hot-dog 2x (Double)', 'Garlic Bread', 'Juice'] },
    ],
  },
  {
    id: 2,
    ...
    orders: [
      { id: 1006, date: '2026-07-26T20:15:00', total: 98000, items: ['Hot-dog oddiy', 'Mashed Potatoes'] },
      { id: 1007, date: '2026-07-24T19:00:00', total: 76000, items: ['Hot-dog oddiy', 'Salad'] },
      { id: 1008, date: '2026-07-21T20:30:00', total: 115000, items: ['Hot-dog oddiy', 'Wine'] },
      { id: 1009, date: '2026-07-19T18:45:00', total: 54000, items: ['Hot-dog oddiy', 'Rice'] },
      { id: 1010, date: '2026-07-17T20:00:00', total: 88000, items: ['Hot-dog oddiy', 'Doner kichik'] },
    ],
  },
  {
    id: 3,
    ...
    favoriteDish: 'Hot-dog 2x (Double)',
    avgCheck: 8250,
    rating: 4.5,
    blacklisted: false,
    notes: "Tushlik payt keladi. Go'sht kam yeydi.",
    orders: [
      { id: 1011, date: '2026-07-25T12:30:00', total: 45000, items: ['Hot-dog 2x (Double)', 'Soup'] },
      { id: 1012, date: '2026-07-23T13:00:00', total: 62000, items: ['Hot-dog 2x (Double)', 'Juice'] },
      { id: 1013, date: '2026-07-20T12:15:00', total: 38000, items: ['Hot-dog 2x (Double)', 'Water'] },
      { id: 1014, date: '2026-07-18T12:45:00', total: 55000, items: ['Hot-dog oddiy', 'Lemonade'] },
      { id: 1015, date: '2026-07-15T13:30:00', total: 41000, items: ['Hot-dog 2x (Double)', 'Coffee'] },
    ],
  },
  {
    id: 4,
    ...
    orders: [
      { id: 1016, date: '2026-07-28T11:00:00', total: 165000, items: ['Hot-dog oddiy', 'Hot-dog 2x (Double)', 'Doner kichik'] },
      { id: 1017, date: '2026-07-26T12:30:00', total: 132000, items: ['Hot-dog oddiy', 'Salad', 'Wine'] },
      { id: 1018, date: '2026-07-24T11:15:00', total: 98000, items: ['Hot-dog oddiy', 'Soup'] },
      { id: 1019, date: '2026-07-22T19:00:00', total: 145000, items: ['Hot-dog oddiy', 'Risotto', 'White Wine'] },
  ...
  },
  {
    ...
    orders: [
      { id: 1021, date: '2026-07-27T19:45:00', total: 178000, items: ['2x Hot-dog oddiy', 'Hot-dog oddiy', 'Wine', 'Lavash'] },
      { id: 1022, date: '2026-07-25T20:00:00', total: 145000, items: ['Hot-dog oddiy', 'Pasta', 'Juice'] },
      { id: 1023, date: '2026-07-22T18:30:00', total: 92000, items: ['Hot-dog 2x (Double)', 'Salad', 'Water'] },
      { id: 1024, date: '2026-07-19T19:15:00', total: 118000, items: ['Hot-dog 2x (Double)', 'Risotto', 'Doner kichik'] },
  ...
  },
  {
    ...
    orders: [
      { id: 1026, date: '2026-07-20T13:00:00', total: 65000, items: ['Hot-dog 2x (Double)', 'Fri'] },
      { id: 1027, date: '2026-07-15T12:30:00', total: 48000, items: ['Burger', 'Doner kichik'] },
      { id: 1028, date: '2026-07-10T13:15:00', total: 72000, items: ['Hot-dog oddiy', 'Salad'] },
  ...
  },
  {
    ...
    orders: [
      { id: 1031, date: '2026-07-26T14:00:00', total: 58000, items: ['Hot-dog 2x (Double)', 'Juice'] },
      { id: 1032, date: '2026-07-23T13:30:00', total: 42000, items: ['Hot-dog 2x (Double)', 'Soup'] },
      { id: 1033, date: '2026-07-19T14:15:00', total: 67000, items: ['Hot-dog 2x (Double)', 'Rice'] },
  ...
  },
  {
    ...
    orders: [
      { id: 1036, date: '2026-07-15T20:30:00', total: 75000, items: ['Burger', 'Fri', 'Doner kichik'] },
      { id: 1037, date: '2026-07-08T19:00:00', total: 42000, items: ['Hot-dog 2x (Double)', 'Doner kichik'] },
      { id: 1038, date: '2026-07-01T20:15:00', total: 58000, items: ['Hot-dog oddiy', 'Salad'] },
  ...
  },
  {
    ...
    orders: [
      { id: 1041, date: '2026-07-28T12:00:00', total: 320000, items: ['5x Hot-dog oddiy', 'Salads', 'Wine bottles'] },
      { id: 1042, date: '2026-07-25T13:00:00', total: 185000, items: ['3x Hot-dog oddiy', 'Pasta', 'Juice'] },
      { id: 1043, date: '2026-07-21T12:30:00', total: 95000, items: ['Hot-dog 2x (Double)', 'Risotto'] },
      { id: 1044, date: '2026-07-18T19:00:00', total: 142000, items: ['Hot-dog oddiy', 'Salad', 'Doner kichik'] },
  ...
  },
  {
    ...
    orders: [
      { id: 1046, date: '2026-07-28T19:00:00', total: 245000, items: ['Hot-dog oddiy', 'Hot-dog oddiy', 'Doner kichik', 'Lavash'] },
      { id: 1047, date: '2026-07-26T20:00:00', total: 178000, items: ['Hot-dog oddiy', 'Salad', 'Wine'] },
      { id: 1048, date: '2026-07-24T18:30:00', total: 132000, items: ['Hot-dog oddiy', 'Soup', 'Juice'] },
      { id: 1049, date: '2026-07-22T19:45:00', total: 198000, items: ['2x Hot-dog oddiy', 'Pasta', 'Doner kichik'] },
